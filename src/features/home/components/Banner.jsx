    ...
    <section className="relative w-full bg-[#FAF9F6] dark:bg-slate-950 overflow-hidden font-sans min-h-[85vh] flex flex-col justify-center items-center py-20">
      ...
      <div className="container mx-auto px-4 max-w-5xl relative z-10 flex flex-col items-center text-center">
        ...
        <motion.div 
          ...
          className="inline-flex items-center gap-2 rounded-full border border-purple-200 dark:border-purple-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md shadow-sm px-4 py-1.5 mb-8"
        >
          <div className="w-5 h-5 rounded-full bg-linear-to-r from-purple-600 to-pink-600 flex items-center justify-center shadow-inner">
        ...
        >
          ...
          <button 
            ...
            className="w-full sm:w-auto bg-linear-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold rounded-lg px-8 py-3.5 shadow-lg shadow-purple-500/25 flex items-center justify-center gap-2 transform transition-all duration-300 hover:scale-105 active:scale-95"
          >
          ...
          <button 
            ...
            className="w-full sm:w-auto border border-purple-300 dark:border-purple-700 text-purple-700 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/30 font-semibold rounded-lg px-8 py-3.5 transition-all duration-300 active:scale-95 bg-white/50 dark:bg-transparent backdrop-blur-sm"
          >
            Explore Packages
          </button>
        </motion.div>
        ...
        <motion.div 
          ...
          className="w-full max-w-4xl mt-16 bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl rounded-2xl border border-purple-100 dark:border-slate-700 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_50px_-12px_rgba(0,0,0,0.4)] p-6 md:p-8 grid grid-cols-1 md:grid-cols-3 gap-6 text-left"
        >
          {/* Box 1 */}
          <div className="flex items-start gap-4">
            <div className="p-3 bg-purple-100 dark:bg-purple-900/50 rounded-xl text-purple-600 dark:text-purple-400 shrink-0">
          ...
          {/* Box 2 */}
          <div className="flex items-start gap-4 md:border-l md:border-slate-200 dark:border-slate-700 md:pl-6">
            <div className="p-3 bg-pink-100 dark:bg-pink-900/50 rounded-xl text-pink-600 dark:text-pink-400 shrink-0">
      ...
      <div className="hidden lg:block absolute left-10 xl:left-24 top-[20%]">
        <motion.div 
          ...
          className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-xl border border-purple-100/50 dark:border-slate-700 flex items-center justify-center transform -rotate-12"
        >
      ...
      <div className="hidden lg:block absolute left-24 xl:left-40 top-[50%]">
        <motion.div 
          ...
          className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-xl border border-purple-100/50 dark:border-slate-700 flex items-center justify-center transform rotate-6 scale-110"
        >
      ...
      <div className="hidden lg:block absolute left-8 xl:left-16 bottom-[25%]">
        <motion.div 
          ...
          className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-xl border border-purple-100/50 dark:border-slate-700 flex items-center justify-center transform -rotate-6"
        >
          <div className="text-3xl">💐</div>
        </motion.div>
      </div>
      ...
      <div className="hidden lg:block absolute right-24 xl:right-48 top-[55%]">
        <motion.div 
          ...
          className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-xl border border-purple-100/50 dark:border-slate-700 flex items-center justify-center transform -rotate-6 scale-125"
        >
          <div className="text-4xl text-rose-500">
             <Gift className="w-10 h-10 fill-rose-100 text-rose-500" />
          </div>
        </motion.div>
      </div>
      <div className="hidden lg:block absolute right-8 xl:right-20 bottom-[15%]">
        ...
        >
          <div className="text-3xl text-indigo-500">
             <Gem className="w-8 h-8 fill-indigo-100 text-indigo-500" />
          </div>
        </motion.div>
      </div>
