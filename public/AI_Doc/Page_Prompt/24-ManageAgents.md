...
- [x] Sub-components live in `src/components/pages/Admin/AgentManagement/` and adhere to the 100-350 lines sizing standard.
...
```
- **Date**: 2026-08-18
- **Target Page**: `src/features/admin/ManageAgents.page.jsx`
- **Actions Taken**:
  - Decomposed 630-line monolithic file into 3 cohesive 100-240 line components under `src/components/pages/Admin/AgentManagement/` (`AgentManagementToolbar.jsx`, `AgentManagementTable.jsx`, `AgentManagementModals.jsx`).
  ...
  - Created clean search input with 350ms debounce and clear button, paired with clean Status and Territory dropdowns.
  ...
  - Built comprehensive agent dossier modal with technical competencies, performance stats, and availability controls.
